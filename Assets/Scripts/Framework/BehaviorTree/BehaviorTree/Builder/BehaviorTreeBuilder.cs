...
namespace CleverCrow.Fluid.BTs.Trees {
    public class BehaviorTreeBuilder {
        ...
        public BehaviorTreeBuilder SequenceCallback (string name = "sequence", Action start= null,
            Action exit = null) {
            var parent = new Sequence() { Name = name, startLogic =start, exitLogic = exit};
            return AddNodeWithPointer(parent);
        }
        ...
        public BehaviorTreeBuilder Do (string name, Func<TaskStatus> action, Action start=null,
            Action exit =null) {
        ...
        public BehaviorTreeBuilder Do (Func<TaskStatus> action, Action start= null,
            Action exit = null) {
            return Do("action", action, start, exit);
        }
