...
namespace FSM
{
        ...
        IActionable<TEvent>
    {
        ...
        public List<StateBase<TStateId>> GetStates()
        {
            return states;
        }
        ...
        [ShowNonSerializedProperty("Active State")]
        ...
        public List<TransitionBase<TStateId>> TransitionsFromAny
        {
            get { return transitionsFromAny; }
        }

        public Dictionary<TEvent, List<TransitionBase<TStateId>>> TriggerTransitionsFromAny
        {
            get { return triggerTransitionsFromAny; }
        }
