...
namespace Newtonsoft.Json.UnityConverters.Math
{
    public class SphericalHarmonicsL2Converter : PartialConverter<SphericalHarmonicsL2>
    {
        ...
        private static readonly Dictionary<string, (int color, int coefficient)> _nameToIndex =
            GetNamesToIndexDictionary(_indices);
        ...
        private static Dictionary<string, (int color, int coefficient)> GetNamesToIndexDictionary(
            (string name, int rgb, int coefficient)[] indices)
        {
        ...
        protected override void ReadValue(ref SphericalHarmonicsL2 value, string name, JsonReader reader,
        ...
        protected override void WriteJsonProperties(JsonWriter writer, SphericalHarmonicsL2 value,
            JsonSerializer serializer)
        {
