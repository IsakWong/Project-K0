    ...
    internal static class SCEditorUtility
    {
        ...
        public static bool HasDrawerForType(Type type)
        {
            ...
            if (attributeUtilityType == null)
                return false;
            var getDrawerMethod =
                attributeUtilityType.GetMethod("GetDrawerTypeForType", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        internal static bool HitTest(Rect rect, Vector2 point) => point.x >= rect.xMin && point.x < rect.xMax &&
